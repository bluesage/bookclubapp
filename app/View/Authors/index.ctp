<div class="authors index">
	...
	<tr>
		...
		<td><?php echo h($author['Author']['other_name']); ?>&nbsp;</td>
		<td><?php echo h($author['Author']['create_date']); ?>&nbsp;</td>
		<td><?php echo h($author['Author']['update_date']); ?>&nbsp;</td>
		<td><?php echo h($author['Author']['delete_date']); ?>&nbsp;</td>
		<td class="actions">
